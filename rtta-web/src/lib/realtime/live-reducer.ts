...
function toUtterance(event: TranslationServerEvent): TranslationUtterance {
  return {
    id: event.utteranceId ?? eventId(event),
  ...
  switch (event.type) {
    case "SESSION_STATE": {
      ...
      return {
        ...
        lastMeetingId: event.meetingId ?? state.lastMeetingId,
    ...
    case "SESSION_STOPPED":
      ...
      return {
        ...
        activeSessionId: null,
        activeMeetingId: null,
        lastMeetingId: event.meetingId ?? state.activeMeetingId ?? state.lastMeetingId,
        sessionStartedAt: null,
        currentPartial: null,
        followLive: true,
      }
